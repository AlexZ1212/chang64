...
- 70427 engine-verified tactics puzzles, with adaptive difficulty, theme filter and Chang Sprint
...
- the written content of the 261 pages, in both languages
...
Le **contenu éditorial** (les textes des 261 pages, la base d'exercices, l'identité
