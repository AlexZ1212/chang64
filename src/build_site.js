...
<header>
  ...
  <nav>
    ...
    <a href="${lang === "fr" ? "/fr/exercices/" : "/puzzles/"}">${d.nav[2]}</a>
    <a href="${lang === "fr" ? "/fr/apprendre/" : "/learn/"}">${lang === "fr" ? "Apprendre" : "Learn"}</a>
    ${otherUrl ? `<a href="${String(otherUrl).replace(SITE, "")}" hreflang="${other}" rel="alternate">${L[other].label}</a>` : ""}
  </nav>
</header>
${body}
