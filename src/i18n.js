...
"Move {a} of {b}: {san}":"Coup {a} sur {b} : {san}",
...
"By pattern":"Par motif",
"Leave":"Quitter",
"Your level stays at {n} while you train this.":"Ton niveau reste à {n} pendant que tu travailles ce motif.",
"Drill one tactic at a time, as long as you like. Your level doesn't move here.":"Travaille un motif à la fois, aussi longtemps que tu veux. Ton niveau ne bouge pas ici.",
"Train one pattern":"Travailler un motif",
"Pick a tactic and drill it. Your level and streak stay where they are.":"Choisis un motif et enchaîne. Ton niveau et ta série restent où ils sont.",
"Tactical patterns":"Motifs tactiques",
"Checkmates":"Les mats",
...
"Upcoming":"À venir",
"{d}, solved":"{d}, résolu",
"{d}, not solved, tap to catch up":"{d}, non résolu, touche pour rattraper",
"{d}, today's puzzle, tap to solve it":"{d}, exercice du jour, touche pour le résoudre",
