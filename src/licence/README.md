...
- __NP__ engine-verified tactics puzzles, with adaptive difficulty, theme filter and Chang Sprint
...
- the written content of the __NPAGES__ pages, in both languages
...
Le **contenu éditorial** (les textes des __NPAGES__ pages, la base d'exercices, l'identité
