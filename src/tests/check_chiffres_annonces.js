...
for (const [p, lbl] of [["/puzzles/index.html", "exercices EN"], ["/fr/exercices/index.html", "exercices FR"]]) {
  ...
  const nb = (h.match(/(\d{3,5})\s*(puzzles|exercices|verified|engine-verified|positions)/) || [])[1];
...
/* Plus une page par exercice individuel depuis la refonte en 13 pages de
   theme (3 exemples travailles chacune) -- corrige le 2026-09-02, cette
   assertion visait a l'origine 1 page par exercice, obsolete depuis que
   la banque est passee a une echelle qui rend ca impraticable. */
T("une page par theme d'exercice", pzEn === 13, pzEn + " pages pour 13 themes");
