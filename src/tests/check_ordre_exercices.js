...
setTimeout(async()=>{
  ...
  /* Le record de Sprint vivait ici avant d'etre deplace dans Defis (voir
     rushBestTrain) : cette section ne l'annonce plus du tout, ni sous son
     ancien nom "Rush best" ni sous "Sprint best". */
  T("plus aucune trace du record Sprint ici", !/Rush best|Sprint best/.test(html));
