...
/* og_render.py garde volontairement le .svg source a cote de chaque .png
   (voir l'en-tete de og_render.py) : il sert de reference pour sauter la
   reconversion si le .png est deja plus recent, ce qui rend les rebuilds
   incrementaux bien plus rapides. Corrige le 2026-09-02 : ce n'etait pas
   un oubli de nettoyage, "aucun SVG residuel" attendait le contraire du
   comportement documente. On verifie desormais qu'il y a bien un .svg
   par .png (le couple attendu), pas qu'ils ont disparu. */
T("un .svg source par .png (cache incremental)", svg === png, svg + " svg pour " + png + " png");
