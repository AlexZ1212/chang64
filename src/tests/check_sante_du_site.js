...
/* Seuil abaisse de 1900 a 400 le 2026-09-02 : la refonte en 13 pages de
   theme (au lieu d'une page par exercice) a fait chuter le nombre total de
   pages HTML sans rien retirer de reel -- 435 pages est la nouvelle norme,
   pas une regression. Le plancher reste utile pour detecter un build
   casse qui ne produirait presque rien. */
T("plus de 400 pages", html.length>=400, html.length);
